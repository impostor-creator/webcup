...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($identity === '' || $password === '') {
        ...
        $u = auth_attempt_login($identity, $password);
        if ($u) {
            header('Location: ' . ((($u['role'] ?? 'user') === 'admin') ? 'admin.php' : 'user.php'));
            exit;
        }
...
<body>
    ...
    <div class="login-container">
        <div class="login-card">
            ...
            <!-- Login Form -->
            <?php if ($error): ?>
              <div style="margin-bottom:16px;padding:12px;border-radius:10px;background:rgba(155,42,77,0.2);border:1px solid rgba(155,42,77,0.8);color:#FF8E9E;">
